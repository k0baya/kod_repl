    ...
    showTips: function(){
        ...
        this.request.requestSend('plugin/msgWarning/message', {}, function(result){
            ...
            var tips = Tips.notify({
                ...
                content: '<div class="info-alert align-left info-alert-error mt-5">'+_.join(msg,'')+'</div><div><button class="kui-btn mt-5 tips-ignore">'+LNG['msgWarning.main.ignoreTips']+'</button></div>'
            });
